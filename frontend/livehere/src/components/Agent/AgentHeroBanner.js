...
import yassmine from "../../assets/yassmine.jpg";
  ...
  return (
    <div>
      ...
      {isClicked ? (
        ...
        <MoreProperty header="Properties" text="Listed Properties By yassmine" />
      )}
    </div>
  );
};
